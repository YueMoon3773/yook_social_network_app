...
const comments = [
    ...
    { id: 8, comment: 'same energy as me rn honestly', date: '2024-01-09' },
    { id: 9, comment: "Day 1 and I'm already stressed on your behalf lol. Please update us", date: '2024-01-10' },
    {
        id: 10,
    ...
    { id: 18, comment: "Congrats!! I'm crying reading this. The thing about your mom 😭", date: '2024-01-12' },
    { id: 19, comment: "3:41 is INCREDIBLE for a first qualifier. You're going to destroy Boston", date: '2024-01-12' },
    {
        id: 20,
        comment:
    ...
    { id: 26, comment: 'CONGRATULATIONS!! Come celebrate soon, dinner is on me', date: '2024-01-14' },
    {
        id: 27,
        comment: "Going to be there Friday for sure. The arroz con pollo is the one I'm most excited about",
        date: '2024-01-14',
    },
    { id: 28, comment: "my monstera is dying and i'm choosing to not think about what that means", date: '2024-01-15' },
    {
        id: 29,
        comment:
    ...
    { id: 37, comment: 'okay what about Ilford HP5 in this framework where does that land', date: '2024-02-07' },
    {
        id: 38,
        comment:
    ...
    { id: 39, comment: "I felt this at 3am last night. Didn't even have a reason. Just awake.", date: '2024-01-18' },
    { id: 40, comment: "the comma after 'sad' is doing a lot of work in this post and I felt it", date: '2024-01-18' },
    {
        id: 41,
        comment:
    ...
    { id: 47, comment: 'Your mom was absolutely with you. No doubt.', date: '2024-04-15' },
    {
        id: 48,
        comment:
    ...
    { id: 52, comment: "Good luck Friday!! I'll be there", date: '2024-02-12' },
    {
        id: 53,
    ...
    { id: 61, comment: 'Valentina sounds like an absolute legend. Hold onto her.', date: '2024-02-19' },
    { id: 62, comment: 'Good people AND fast learners are the rarest combination. You got lucky.', date: '2024-02-19' },
    {
        id: 63,
    ...
    { id: 74, comment: '41 years. I hope I get to write something like this someday.', date: '2024-04-06' },
    { id: 75, comment: "The chair detail broke me. I'm so sorry for your loss.", date: '2024-04-06' },
    { id: 76, comment: 'logo revision 14 should be a war crime', date: '2024-01-26' },
    {
        id: 77,
    ...
    { id: 88, comment: "The plant is thriving and that's the only update I needed today", date: '2024-01-15' },
    {
        id: 89,
