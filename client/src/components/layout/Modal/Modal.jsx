...
const modalSchema = z.object({
    ...
    postTitleValue: z.string().nullable().optional(),
    postTitleOnChangeHandler: z.function().nullable().optional(),
    postContentValue: z.string().nullable().optional(),
    postContentOnChangeHandler: z.function().nullable().optional(),
    profileFirstNameValue: z.string().nullable().optional(),
    profileFirstNameOnChangeHandler: z.function().nullable().optional(),
    profileLastNameValue: z.string().nullable().optional(),
    ...
    profileBioValue: z.string().nullable().optional(),
    profileBioOnChangeHandler: z.function().nullable().optional(),
    profileLocationValue: z.string().nullable().optional(),
    profileLocationOnChangeHandler: z.function().nullable().optional(),
    profileBirthdayValue: z.string().nullable().optional(),
